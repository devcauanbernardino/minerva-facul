                ...
                <Card key={d.materiaId} className="gap-0 overflow-hidden p-0">
                  <CardContent className="space-y-3 p-5">
                    ...
                    <div className="flex items-center justify-between text-xs text-muted-foreground">
                      <span>
                        Nota final: <span className="font-semibold text-foreground">{formatarNota(d.nota)}</span>
                      </span>
                      <span>
                        Frequência: <span className="font-semibold text-foreground">{formatarFrequencia(d.frequencia)}</span>
                      </span>
                    </div>
                  </CardContent>
                </Card>
